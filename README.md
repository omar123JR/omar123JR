...
```bash
# --------------------------------------------------------------------
# HOST IDENTITY & TELEMETRY
# --------------------------------------------------------------------
[identity]
  operator     = "Omar"
  designation  = "Cybersecurity Analyst / SOC Automation Engineer"
  status       = "Defending endpoints, automating incident containment"

[core_objectives]
  01. Threat Hunting: Deep packet & host log telemetry inspection
